...
export default function Hero() {
  ...
  return (
    <section className="relative w-full h-full min-h-svh overflow-hidden font-sans bg-white">
      ...
      <div className="relative z-[2] max-w-[1360px] mx-auto">
        <nav className="relative flex items-center justify-between px-20 pt-6 pb-4 max-md:px-6 max-md:pt-5">
          ...
          <div className="flex items-center gap-8">
            ...
            <a
              ...
              className="inline-flex items-center bg-wandor-dark text-[#fafafa] border-none cursor-pointer font-sans text-[15px] font-medium uppercase tracking-[0.04em] px-5 py-3.5 rounded-full transition-all hover:bg-[#333] active:scale-95 no-underline"
            >
              Launch app
            </a>
          </div>
        ...
        <div className="flex flex-col items-center px-6 pt-16 pb-24 text-center">
          <h1 className="font-sans text-[clamp(40px,6vw,68px)] font-medium text-wandor-text leading-[1.05] tracking-[-0.04em] max-w-[820px] mb-5">
            Ready to keep it private?
          </h1>
          <p className="font-sans text-xl font-medium text-wandor-muted leading-relaxed max-w-[500px] mb-10">
            Point the vault at your Safe, drop in your team&rsquo;s addresses,
            and Nox handles the rest &mdash; each amount encrypted end-to-end,
          ...
          <div className="relative w-[701px] max-md:w-[calc(100vw-48px)] min-h-[208px] bg-white/[0.06] border-[3px] border-white rounded-[44px] shadow-[0_0_4px_0_rgba(0,0,0,0.15)] overflow-hidden backdrop-blur-[20px]">
            <p className="absolute left-[29px] top-[57px] -translate-y-1/2 w-[609px] max-md:w-[calc(100%-58px)] font-sans text-xl max-md:text-[17px] font-medium text-wandor-prompt leading-relaxed break-words text-left">
              Pay 8 engineers on Friday from our Sepolia Safe. Salaries stay
              encrypted end-to-end, everyone unwraps when they want
              liquidity....
            </p>
            ...
            <button
              ...
              aria-label="Upload employee list"
