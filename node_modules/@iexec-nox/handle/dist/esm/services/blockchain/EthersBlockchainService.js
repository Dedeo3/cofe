...
export function isEthersSigner(object) {
    return (!!object &&
...
export function isEthersBrowserProvider(object) {
    return (!!object &&
        typeof object === 'object' &&
        'getSigner' in object &&
...
export class EthersBlockchainService {
    ...
    async readContract(contractAddress, abiFunctionFragment, parameters) {
        try {
            ...
            throw new Error(`Failed to read contract at ${contractAddress} (method: ${abiFunctionFragment.name}, parameters: ${safeJsonStringify(parameters)})`, {
                cause: error,
            });
        }
    }
