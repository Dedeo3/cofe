import { createTestClient, createWalletClient, encodeFunctionData, http, pad, publicActions, } from "viem";
import { hardhat } from "viem/chains";
import { ERC1967_IMPLEMENTATION_SLOT, ERC1967_PROXY_ARTIFACT_PATH, NOX_COMPUTE_ADDRESS, NOX_COMPUTE_ARTIFACT_PATH, NOX_COMPUTE_IMPL_ADDRESS, NOX_GATEWAY_ADDRESS, NOX_KMS_PUBLIC_KEY, } from "../nox-config.js";
 ...
 */
export async function deployNoxCompute(rpcUrl) {
    ...
    const walletClient = createWalletClient({ chain: hardhat, transport }).extend(publicActions);
    ...
    const { contractAddress: deployedImplAddress } = await walletClient.waitForTransactionReceipt({ hash: implDeployHash });
...
//# sourceMappingURL=nox-compute.js.map