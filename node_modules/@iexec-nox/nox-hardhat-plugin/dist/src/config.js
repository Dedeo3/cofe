...
export async function validatePluginConfig(userConfig) {
    ...
    if (nox.skipTestOverride !== undefined &&
 ...
 */
export function withInjectedNetworks(userConfig) {
    return {
        ...userConfig,
        networks: {
            [NOX_HOST_NETWORK]: {
...
export async function resolvePluginConfig(userConfig, partiallyResolvedConfig) {
    return {
